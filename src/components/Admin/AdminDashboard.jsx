...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const fetchMonthlyData = async () => {
      ...
      if (currentMonthError || lastMonthError) {
        console.error(
          "Error fetching data:",
          currentMonthError || lastMonthError
        );
        return;
      }
  ...
  return (
    <>
      <div className="min-h-screen bg-gray-100 font-mono flex flex-col xl:flex-row">
        <AdminSidebar />
            ...
            <div className="max-w-4xl mx-auto space-y-6 mb-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white p-4 rounded-lg shadow">
                  ...
                  <div className="relative h-64">
                    <Bar data={dafData} options={chartOptions} />
                  </div>
                </div>
              </div>
            </div>
